...
위와 같은 방법으로 Github를 Server에서 실시간으로 연동하고 수정된 사항을 반영하면,
팀원분들은 Server에 별도의 Remote Access를 필요로 하지 않습니다.

따라서 각자의 Host OS에서 최소한의 인프라로 작업을 원활하게 수행할 수 있으며,
서버 관리 및 접속과 조작에 대한 부담을 최대한 덜어드리고자 이와 같은 인프라를 구축 하였습니다.
